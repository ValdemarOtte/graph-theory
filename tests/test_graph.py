...
class TestGraph:
    def test_valid_graph(self, simple_graph: Graph):
        valid_graph = {"a": ["b", "a", "a", "c", "b"], "b": ["a", "c", "a"], "c": ["a", "b"]}
        assert simple_graph.graph == valid_graph

    def test_valid_vertices(self, simple_graph: Graph):
        valid_vertices = ["a", "b", "c"]
        assert simple_graph.vertices == valid_vertices

    def test_valid_adjacency_matrix(self, simple_graph: Graph):
